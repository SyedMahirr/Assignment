...
public class HomePage {
	 ...
	 * SeleniumUtils.click(lnk_globalview); return new GlobalViewPage(); } public
	 * FacilityViewPage clickOnFacilityView() {
	 * SeleniumUtils.click(lnk_facilityview); return new FacilityViewPage(); }
	 * public MovementPage clickOnMovement() { SeleniumUtils.click(lnk_movement);
	 * return new MovementPage(); } public AccountViewPage clickOnAccountView() {
	 * SeleniumUtils.click(lnk_accountview); return new AccountViewPage(); }
	 * 
	 * public void searchOnGoogle(String value) {
	 * //SeleniumUtils.sendkeys(searchBox, "automation"); String
	 * newxpath=DynamicXpath.get(txtbox_searchbox, "q");
	 * SeleniumUtils.sendkeys(Driver.driver.findElement(By.xpath(newxpath)),value);
	 * }
	 * 
	 * public boolean checkDefaultTabSelectedIsGlobalView() { try {
	 * Thread.sleep(5000); } catch (InterruptedException e) { // TODO Auto-generated
	 * catch block e.printStackTrace(); }
	 * if(txt_exceptionpercountryfor.isDisplayed()==true) { com.reports.LogStatus.
	 * pass("Text : Exception country for is verified in the Global view"); }
	 * TestUtils.takeScreenshot(); return txt_exceptionpercountryfor.isDisplayed();
	 * }
	 */
}
